...
//                {
//                    bufferedWriter.write("send file");
//                    bufferedWriter.flush();
//                    System.out.println("request for a file sent, now waiting...");
//
//                    String byteData = bufferedReader.readLine();
//                    JSONObject jsonByteData = new JSONObject(byteData);
//
//                    System.out.println(jsonByteData.get("ByteData"));
//                }
//                else
//                {
